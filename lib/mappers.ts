...
export function mapGift(row: Record<string, any>): GiftAsset {
  ...
  return {
    ...
    catalogSource: row.catalog_source === "telegram_resale" ? "telegram_resale" : "profile_sync",
    telegramResalePriceTon: nullableNumber(row.telegram_resale_price_ton, "Telegram resale TON price"),
