...
export default function OrdersPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl">
      ...
      <div className="mb-3 flex items-end justify-between gap-3"><div><h1 className="text-[15px] font-semibold tracking-[-.02em]">Ордера</h1><p className="mt-1 text-[10px] text-[var(--muted)]">Офферы и активные листинги</p></div></div>
