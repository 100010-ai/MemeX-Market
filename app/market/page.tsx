...
import { BarChart3, Flame, Gift, ListFilter, Plus, Search, SlidersHorizontal, Sparkles, Star, X } from "lucide-react";
...
type MarketPayload = { coins: Coin[]; gifts: GiftAsset[]; collections: GiftCollection[]; watchlist: Watchlist };
...
export default function MarketPage() {
  const [data, setData] = useState<MarketPayload>({ coins: [], gifts: [], collections: [], watchlist: emptyWatchlist });
  ...
  return (
    <div className="mx-auto max-w-6xl">
      <RealtimeRefresh channelName="mxm-market-v07" tables={realtimeTables} onChange={realtimeReload} />
