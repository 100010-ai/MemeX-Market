...
export default function ProfilePage() {
  ...
  return <div className="mx-auto max-w-2xl">
    ...
    <section className="mt-3 grid grid-cols-2 gap-2"><ProfileAction href="/watchlist" icon={<Star size={15} fill="currentColor" />} title="Избранное" detail="Watchlist и price alerts" /><ProfileAction href="/notifications" icon={<Bell size={15} />} title="Уведомления" detail="События и настройки" /><ProfileAction href="/store" icon={<Store size={15} />} title="MXM Store" detail="Покупки за Telegram Stars" /><ProfileAction href="/profile/customize" icon={<Palette size={15} />} title="Оформление" detail="Рамки и коллекционные бейджи" /><ProfileAction href="/referrals" icon={<UsersRound size={15} />} title="Рефералы" detail="Бонусы от приглашённых" /></section>
