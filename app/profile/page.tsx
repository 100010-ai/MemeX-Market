...
export default function ProfilePage() {
  ...
  return <div className="mx-auto max-w-2xl">
    ...
    <section className="mt-3 grid grid-cols-2 gap-2"><ProfileAction href="/watchlist" icon={<Star size={15} fill="currentColor" />} title="Избранное" detail="Watchlist и price alerts" /><ProfileAction href="/notifications" icon={<Bell size={15} />} title="Уведомления" detail="События и настройки" /><ProfileAction href="/support" icon={<Star size={15} fill="currentColor" />} title="Stars" detail="Пополнить баланс" /><ProfileAction href="/referrals" icon={<UsersRound size={15} />} title="Рефералы" detail="Доход от приглашённых" /></section>
