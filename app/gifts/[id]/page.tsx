...
export default function GiftPage() {
  ...
  if (!data) return <div className="mx-auto max-w-5xl"><div className="mxm-skeleton h-[560px] rounded-[18px]" />{error ? <p className="mt-3 text-xs text-[var(--negative)]">{error}</p> : null}</div>;
  const { gift } = data;
