...
const items = [
  ...
  },
  {
    ...
    text: "Вход подтверждается данными мини-приложения Telegram. Никому не передавайте коды, токены бота или данные своей Telegram-сессии; команда MXM не запрашивает их в личных сообщениях.",
  },
];
