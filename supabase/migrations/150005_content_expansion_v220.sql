...
-- Existing rewards remain untouched so previously opened cases keep their historical odds.
...
values
  ...
  -- Black Ice Protocol = 10,000 weight.
  ...
  -- Monolith Reserve = 10,000 weight.
  ...
  -- Singularity 1500 = 10,000 weight.
