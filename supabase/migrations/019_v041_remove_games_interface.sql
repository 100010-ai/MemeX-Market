...
revoke execute on function public.play_virtual_game(uuid,text,numeric,text) from public,anon,authenticated,service_role;
revoke execute on function public.play_virtual_game(uuid,text,numeric,text,text) from public,anon,authenticated,service_role;
