...
-- Fast path for the overwhelmingly common market request: no catalogue filters,
-- all price/view modes, random seeded ordering. Keeping this RPC specialized lets
-- PostgreSQL push the literal listed-state predicate into virtual_gifts_market_idx.
